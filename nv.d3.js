...
nv.models.stackedAreaChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      if (showControls) {
        var controlsData = [
          { key: 'Empilage', disabled: stacked.offset() != 'zero' },
          { key: 'Flot', disabled: stacked.offset() != 'wiggle' },
          { key: 'Étendues', disabled: stacked.offset() != 'expand' }
        ];
